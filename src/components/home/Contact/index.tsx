        ...
        <div className="card-mensage">
          <div className="header-mensage">
            ...
            <p className="ph-mensage">
              E entraremos em contato para encontrar a melhor solução para você
              e seu negócio.
            </p>
          </div>

          <div className="form-area">
            <FormMen title="Nome Completo" />
            <FormMen title="E-mail" />
            <FormMen title="Telefone" />

            <div className="men-area">
              <h5 className="tit-area">Mensagem</h5>
              <textarea className="text-area-men"></textarea>
            </div>
